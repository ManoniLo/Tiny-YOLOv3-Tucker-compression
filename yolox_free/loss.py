...
from yolox_free.postprocess import yolox_decode
...
def yolox_loss(args, anchors, num_classes, ignore_thresh=.5, label_smoothing=0, elim_grid_sense=False, use_focal_loss=False, use_focal_obj_loss=False, use_softmax_loss=False, use_giou_loss=False, use_diou_loss=True):
    '''
    ...
    for i in range(num_layers):
        ...
        grid, raw_pred, pred_xy, pred_wh = yolox_decode(yolo_outputs[i],

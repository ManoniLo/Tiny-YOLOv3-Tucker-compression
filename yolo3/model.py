...
from yolo3.models.yolo3_resnet50 import (
    yolo3_resnet50_body,
    yolo3lite_resnet50_body,
    yolo3lite_spp_resnet50_body,
    tiny_yolo3_resnet50_body,
...
from yolo4.models.yolo4_mobilenet import (
    ...
    tiny_yolo4_mobilenet_body,
    tiny_yolo4lite_mobilenet_body,
)
from yolo4.models.yolo4_mobilenetv2 import (
    yolo4_mobilenetv2_body,
    yolo4lite_mobilenetv2_body,
    tiny_yolo4_mobilenetv2_body,
    tiny_yolo4lite_mobilenetv2_body,
)

from yolo4.models.yolo4_mobilenetv3_large import (
    yolo4_mobilenetv3large_body,
    yolo4lite_mobilenetv3large_body,
    tiny_yolo4_mobilenetv3large_body,
    tiny_yolo4lite_mobilenetv3large_body,
)
from yolo4.models.yolo4_mobilenetv3_small import (
    yolo4_mobilenetv3small_body,
    yolo4lite_mobilenetv3small_body,
    tiny_yolo4_mobilenetv3small_body,
    tiny_yolo4lite_mobilenetv3small_body,
)
from yolo4.models.yolo4_efficientnet import (
    yolo4_efficientnet_body,
    yolo4lite_efficientnet_body,
    tiny_yolo4_efficientnet_body,
    tiny_yolo4lite_efficientnet_body,
)
from yolo4.models.yolo4_resnet50 import (
    yolo4_resnet50_body,
    yolo4lite_resnet50_body,
    tiny_yolo4_resnet50_body,
    tiny_yolo4lite_resnet50_body,
)
...
from yolo3.postprocess import (
    batched_yolo3_postprocess,
    batched_yolo3_prenms,
    Yolo3PostProcessLayer,
)
...
yolo3_model_map = {
    ...
    "yolo3_mobilenetv3small_ultralite": [
        yolo3_ultralite_mobilenetv3small_body,
        166,
        None,
    ],
    ...
    "yolo_lite_custom": [yolo_lite_custom_body, 20, None],
...
yolo3_tiny_model_map = {
    ...
    "tiny_yolo4_mobilenet_lite_nospp": [
        partial(tiny_yolo4lite_mobilenet_body, use_spp=False),
        87,
        None,
    ],
    ...
    "tiny_yolo4_mobilenetv2_lite_nospp": [
        partial(tiny_yolo4lite_mobilenetv2_body, use_spp=False),
        155,
        None,
    ],
    "tiny_yolo4_mobilenetv3large": [tiny_yolo4_mobilenetv3large_body, 195, None],
    "tiny_yolo4_mobilenetv3large_lite": [
        tiny_yolo4lite_mobilenetv3large_body,
        195,
        None,
    ],
    "tiny_yolo4_mobilenetv3large_lite_nospp": [
        partial(tiny_yolo4lite_mobilenetv3large_body, use_spp=False),
        195,
        None,
    ],
    "tiny_yolo4_mobilenetv3small": [tiny_yolo4_mobilenetv3small_body, 166, None],
    "tiny_yolo4_mobilenetv3small_lite": [
        tiny_yolo4lite_mobilenetv3small_body,
        166,
        None,
    ],
    "tiny_yolo4_mobilenetv3small_lite_nospp": [
        partial(tiny_yolo4lite_mobilenetv3small_body, use_spp=False),
        166,
        None,
    ],
    ...
    "tiny_yolo4_efficientnet_lite_nospp": [
        partial(tiny_yolo4lite_efficientnet_body, use_spp=False),
        235,
        None,
    ],
}

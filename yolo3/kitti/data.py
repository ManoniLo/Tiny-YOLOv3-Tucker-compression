...
def get_ground_truth_data(annotation_line, input_shape, augment=True, random_padd = True, letterbox_padd = False, max_boxes=100):
    ...
    if not augment:
        if letterbox_padd:
            ...
            new_image = image.resize(tuple(reversed(model_input_size)))
...
class Yolo3DataGenerator(Sequence):
    def __init__(self, annotation_lines, batch_size, input_shape, anchors, num_classes, enhance_augment=None,
        ...
        self.random_padd = random_padd
        self.letterbox_padd = letterbox_padd
    ...
    def __getitem__(self, index):
        ...
        for b in range(self.batch_size):
            image, box = get_ground_truth_data(batch_annotation_lines[b], self.input_shape, augment=True, random_padd = self.random_padd, letterbox_padd = self.letterbox_padd)

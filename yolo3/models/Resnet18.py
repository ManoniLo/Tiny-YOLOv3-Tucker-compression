...
def residual_conv_block(filters, stage, block, strides=(1, 1), attention=None, cut='pre'):
    ...
    def layer(input_tensor):
        ...
        x = layers.Add(name='stage{}_unit{}_output'.format(stage+1,block+1))([x, shortcut])
        return x
...
# New definition, added by Lorenzo...........................
#MODELS_PARAMS = {
#    'resnet18': ModelParams('resnet18', (1, 1, 1, 2), residual_conv_block, None),
#}
